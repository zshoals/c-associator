#ifndef AVOLITTY_ASSOCIATOR_H
#define AVOLITTY_ASSOCIATOR_H
...
unsigned char AvolittyAssociatorE();

unsigned char AvolittyAssociatorF(void * * a, unsigned long * * * b, unsigned long * c, unsigned long * d, unsigned long * e, unsigned long f, unsigned char * * * * g, unsigned char * * * * h, unsigned char i, unsigned char j);

unsigned char AvolittyAssociatorG(void * a, void * b, unsigned long c, unsigned char * d);

void AvolittyAssociatorH(void * a, unsigned long int b, unsigned char * c);
